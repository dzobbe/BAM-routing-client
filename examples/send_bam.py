#!/usr/bin/env python3
"""
Simple example for sending Solana transactions via BAM Smart Routing using Phantom wallet.
"""
...
async def main():
    # Connect to Phantom wallet instead of generating keypair
